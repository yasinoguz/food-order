...
const AddProduct = ({ setIsProductModal }) => {
  ...
  const handleCreate = async () => {
    ...
    data.append("upload_preset", "food-order");
    try {
      const uploadRes = await axios.post(
        "https://api.cloudinary.com/v1_1/dy4oo1bqp/image/upload",
        data
      );
            ...
            <div className="flex flex-col text-sm mt-4 w-full">
              ...
              <div className="flex  gap-6 w-full md:flex-nowrap flex-wrap">
                ...
                <input
                  ...
                  onChange={
                    (e) =>
                      setExtra({ ...extra, [e.target.name]: e.target.value }) //set extra obje ıkı tane deger var oyuzden ... ıle doldurma
                  }
                />
